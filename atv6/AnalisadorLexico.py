...
class AnalisadorLexico:
    ...
    def verificar_parenteses(self):
        if self.codigo and self.codigo[0] != '(' and self.codigo[-1] != ')':
            raise ValueError("Expressão deve estar entre parênteses ou deve ser uma constante")
